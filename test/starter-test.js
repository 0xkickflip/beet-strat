...
describe('Vaults', function () {
  ...
  const wantHolderAddr = '0xdb7D775ce48Be3c112e9b9b3f367d1c679c56088';
  const lqdrHolderAddr = '0x1c664bafc646510684ba1588798c67fe22a8c7cf';
  ...
  beforeEach(async function () {
    ...
    await hre.network.provider.request({
      method: 'hardhat_impersonateAccount',
      params: [lqdrHolderAddr],
    });
    wantHolder = await ethers.provider.getSigner(wantHolderAddr);
    lqdrHolder = await ethers.provider.getSigner(lqdrHolderAddr);
    await hre.network.provider.request({
      method: 'hardhat_impersonateAccount',
    ...
    Lqdr = await ethers.getContractFactory('@openzeppelin/contracts/token/ERC20/ERC20.sol:ERC20');
    ...
    lqdr = await Lqdr.attach(lqdrAddress);
  ...
  describe('Vault Tests', function () {
    ...
    it('should provide yield', async function () {
      ...
      for (let i = 0; i < numHarvests; i++) {
        // await lqdr.connect(lqdrHolder).transfer(strategy.address, toWantUnit('10'));
  ...
  describe('Strategy', function () {
    ...
    it('should be able to estimate harvest', async function () {
      const whaleDepositAmount = toWantUnit('900');
