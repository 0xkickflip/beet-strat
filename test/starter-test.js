...
describe('Vaults', function () {
  ...
  const wantHolderAddr = '0xe2807b921dfdaaf71a4a85bc2d2ca5c300cbb555';
  ...
  beforeEach(async function () {
    ...
    Strategy = await ethers.getContractFactory('ReaperStrategyBeethovenPirateInC');
    Want = await ethers.getContractFactory('@openzeppelin/contracts/token/ERC20/ERC20.sol:ERC20');

    //deploy contracts
    vault = await Vault.deploy(
      wantAddress,
      'Pirate In C Beethoven-X Crypt',
      'rf-BPT-cLQDR',
      0,
