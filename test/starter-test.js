...
describe('Vaults', function () {
  ...
  const wantHolderAddr = '0x9915eb519fbaab6bec191c767a4e230239f95140';
  ...
  beforeEach(async function () {
    ...
    Strategy = await ethers.getContractFactory('ReaperStrategyBeethovenWaterMusic');
