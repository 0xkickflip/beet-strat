...
describe('Vaults', function () {
  ...
  const wantHolderAddr = '0xa1e849b1d6c2fd31c63eef7822e9e0632411ada7';
  ...
  beforeEach(async function () {
    ...
    Strategy = await ethers.getContractFactory('ReaperStrategy_bb_yv_FTMUSD');
