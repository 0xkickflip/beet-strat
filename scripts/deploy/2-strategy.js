...
async function main() {
  ...
  const want = '0x56aD84b777ff732de69E85813DAEE1393a9FFE10';
  const mcPoolId = 99;
  const Strategy = await ethers.getContractFactory('ReaperStrategyBeethovenFantomOfTheOperaII');
  ...
  const strategist5 = '0x60bc5e0440c867eeb4cbce84bb1123fad2b262b1';
  ...
  const strategy = await hre.upgrades.deployProxy(
    ...
    [
      vaultAddress,
      treasuryAddress,
      [strategist1, strategist2, strategist3, strategist4, strategist5],
